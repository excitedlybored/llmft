    ...
    def setup(self, args, state, model, wandb_args, data_args, ft_args, **kwargs):
        ...
        if state.is_world_process_zero:
            ...
            if hasattr(model, "config") and model.config is not None:
                ...
                data_args = data_args.to_dict() if data_args else {}
                ft_args = ft_args.to_dict() if ft_args else {}
...
class FtTrainer(Trainer):
        ...
        if not eval_only:
            ...
            for n, p in self.model.named_parameters():
                ...
                if "score" in n or "lm_head" in n:  # always train output layers
                    ...
                    if p.requires_grad:
                        trainable_params_names.append(n)
            #jason comment: code store the trainable parameters names in the class
    ...
    def _inner_training_loop(
        ...
        delay_optimizer_creation = None #self.fsdp is not None
    ...
    def evaluation_loop(
        ...
        # turn on evaluation mode in the model - pytorch will disable dropout, etc.
        model.eval()
